...
#if defined(__sparc__) // to be able to use libstdc++ ontop 
weak_alias (__XL(strtol),__strtol_internal)
#endif
...
#if defined(__sparc__) // to be able to use libstdc++ ontop 
weak_alias (__XL(strtoll),__strtoll_internal)
#endif
...
#if defined(__sparc__) // to be able to use libstdc++ ontop 
weak_alias (__XL(strtoul),__strtoul_internal)
#endif
...
#if defined(__sparc__) // to be able to use libstdc++ ontop 
weak_alias (__XL(strtoull),__strtoull_internal)
#endif
