...
//#define __NR_fork             2
#ifdef L___libc_fork
#if !defined(__sparc__) //use sysdep/linux/sparc/fork.S
#include <unistd.h>
...
//#define __NR_pipe             42
#ifdef L_pipe
#if !defined(__sparc__) //use sysdep/linux/sparc/pipe.S
#include <unistd.h>
...
#if !defined(__sparc__) || !defined(__UCLIBC_HAS_MMU__)
#include <unistd.h>
#include <sys/mman.h>
...
#if !defined(__sparc__) //use sysdep/linux/sparc/wait4.S
static inline
...
_syscall5(int, __syscall_rt_sigaction, int, signum, const struct sigaction *, act, 
		struct sigaction *, oldact, void *, restorer, size_t, size); 
