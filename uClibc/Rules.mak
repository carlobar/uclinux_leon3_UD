...
-DKERNEL_VERSION=$(shell sh $(TOPDIR)/extra/scripts/getversion.sh -k $(KERNEL_SOURCE) -t VERSION 2> /dev/null) \
-DKERNEL_PATCHLEVEL=$(shell sh $(TOPDIR)/extra/scripts/getversion.sh -k $(KERNEL_SOURCE) -t PATCHLEVEL 2> /dev/null) \
-DKERNEL_SUBLEVEL=$(shell sh $(TOPDIR)/extra/scripts/getversion.sh -k $(KERNEL_SOURCE) -t SUBLEVEL 2> /dev/null) 
