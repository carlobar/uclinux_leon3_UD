...
# Vendor Gaisler
#
CONFIG_GRLIB_GAISLER_APBUART=y
CONFIG_GRLIB_GAISLER_APBUART_FIXED=y
# CONFIG_GRLIB_GAISLER_VGA is not set
# CONFIG_GRLIB_GAISLER_PS2 is not set

#
# Vendor Opencores
#
# CONFIG_GRLIB_OPENCORES_ETHERNET is not set
