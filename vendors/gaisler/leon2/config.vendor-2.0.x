...
# Core Applications
#
CONFIG_USER_CUSTOM=y
# CONFIG_USER_CANTEST is not set
# CONFIG_USER_MODULE_INIT_TOOLS is not set
...
#
# CONFIG_USER_TTCP is not set
# CONFIG_USER_ETHSPW is not set
...
# CONFIG_USER_BUSYBOX_FANCY_PING is not set
