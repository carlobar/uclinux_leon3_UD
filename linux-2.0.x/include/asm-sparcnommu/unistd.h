 ...
 * Modified for use with sparcnommu. Changed system call numbers
 * to match most other architectures (i386, m68k, and arm at least).
 *
 * File based on full sparc vm unistd.h which was:
 *
