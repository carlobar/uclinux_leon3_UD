...
#define REGWIN_SZ     STACKFRAME_SZ //sizeof(struct reg_window)
#define PURE_REGWIN_SZ sizeof(struct dummy_reg_window)
...
#define REGWIN_SZ         STACKFRAME_SZ /*0x40*/
#define PURE_REGWIN_SZ    0x40   
#endif
