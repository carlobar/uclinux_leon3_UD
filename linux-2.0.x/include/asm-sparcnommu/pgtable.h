...
#if !defined(NO_MM) || defined(CONFIG_LEON_3) || defined(CONFIG_LEON_2)
...
#ifdef CONFIG_LEON_3
#define flush_cache_all      leon3_cache_flush_all
extern inline void flush_cache_mm(struct mm_struct *mm) {
    leon3_cache_flush_all();
}
extern inline void flush_cache_range(struct mm_struct *mm, unsigned long start, unsigned long end) {
    leon3_cache_flush_all();
}
extern inline void flush_cache_page(struct vm_area_struct *vma, unsigned long vmaddr) {
    leon3_cache_flush_all();
}
extern inline void flush_page_to_ram(unsigned long page) { 
    leon3_cache_flush_all();
}
...
#define flush_cache_all      leon2_cache_flush_all
extern inline void flush_cache_mm(struct mm_struct *mm) {
    leon2_cache_flush_all();
}
extern inline void flush_cache_range(struct mm_struct *mm, unsigned long start, unsigned long end) {
    leon2_cache_flush_all();
}
...
extern void (*flush_cache_range)(struct mm_struct *, unsigned long start, unsigned long end);
