...
static struct proc_dir_entry proc_ip_mr_vif = {
		PROC_NET_IPMR_VIF, 9 ,"ip_mr_vif",
		S_IFREG | S_IRUGO, 1, 0, 0,
		0, &proc_net_inode_operations,
		ipmr_vif_info
	});
static struct proc_dir_entry proc_ip_mr_cache = {
...
#ifdef CONFIG_PROC_FS	
	proc_net_register(&proc_ip_mr_vif);
	proc_net_register(&proc_ip_mr_cache);
#endif	
}
