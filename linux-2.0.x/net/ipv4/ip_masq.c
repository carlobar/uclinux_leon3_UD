 ...
 *	Rudolf Lippan		:	dest hashing bugfix
 *
 */
...
static struct proc_dir_entry proc_ip_masquerade = {
...
#ifdef CONFIG_IP_MASQUERADE_IPAUTOFW
static struct proc_dir_entry proc_ip_autofw = {
...
#endif /* CONFIG_IP_MASQUERADE_IPAUTOFW */
#ifdef CONFIG_IP_MASQUERADE_IPPORTFW
static struct proc_dir_entry proc_ip_portfw = {
...
#endif /* CONFIG_IP_MASQUERADE_IPSEC */
#ifdef CONFIG_PROC_FS        
	proc_net_register(&proc_ip_masquerade);
#ifdef CONFIG_IP_MASQUERADE_IPAUTOFW
	proc_net_register(&proc_ip_autofw);
#endif /* CONFIG_IP_MASQUERADE_IPAUTOFW */
#ifdef CONFIG_IP_MASQUERADE_IPPORTFW
	proc_net_register(&proc_ip_portfw);
#endif /* CONFIG_IP_MASQUERADE_IPPORTFW */
#endif /* CONFIG_PROC_FS */
        ip_masq_app_init();
...
#if !defined(MODULE)
{
	...
	extern int ip_masq_raudio_init(void), ip_masq_cuseeme_init(void);
	extern int ip_masq_vdolive_init(void), ip_masq_quake_init(void);
