...
#ifdef CONFIG_IP_ACCT
static struct proc_dir_entry proc_ip_acct = {
...
#ifdef CONFIG_IP_FIREWALL
#ifdef CONFIG_PROC_FS
static struct proc_dir_entry proc_ip_input = {
...
static struct proc_dir_entry proc_ip_output = {
	proc_net_register(&(struct proc_dir_entry) {
...
static struct proc_dir_entry proc_ip_forward = {
	proc_net_register(&(struct proc_dir_entry) {
...
#ifdef CONFIG_PROC_FS
#ifdef CONFIG_IP_ACCT
	proc_net_register(&proc_ip_acct);
#endif
#endif
#ifdef CONFIG_IP_FIREWALL
...
#ifdef CONFIG_PROC_FS
	proc_net_register(&proc_ip_input);
	proc_net_register(&proc_ip_output);
	proc_net_register(&proc_ip_forward);
#endif
#endif
#ifdef CONFIG_IP_MASQUERADE
