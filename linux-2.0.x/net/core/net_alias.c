...
static struct proc_dir_entry proc_alias_types = {
    PROC_NET_ALIAS_TYPES, 11, "alias_types",
    S_IFREG | S_IRUGO, 1, 0, 0,
    0, &proc_net_inode_operations,
    net_alias_types_getinfo
};
static struct proc_dir_entry proc_aliases = {
...
#ifndef ALIAS_USER_LAND_DEBUG
#ifdef CONFIG_PROC_FS
  proc_net_register(&proc_alias_types);
  proc_net_register(&proc_aliases);
#endif
#endif
