...
#ifdef CONFIG_GRLIB_GAISLER_PS2_KEYBOARD
...
static unsigned char e0_keys[128] = {
  0, 0, 0, 0, 0, 0, 0, 0,			      /* 0x00-0x07 */
  0, 0, 0, 0, 0, 0, 0, 0,			      /* 0x08-0x0f */
  0, E0_RALT, 0, 0, E0_RCTRL, 0, 0, 0,		      /* 0x10-0x17 */
  0, 0, 0, 0, 0, 0, 0, E0_MSLW,                       /* 0x18-0x1f */
  0, 0, 0, 0, 0, 0, 0, E0_MSRW,			      /* 0x20-0x27 */
  0, 0, 0, 0, 0, 0, 0, E0_MSTM,			      /* 0x28-0x2f */
  0, 0, 0, 0, 0, 0, 0, 0,	                      /* 0x30-0x37 */
  0, 0, 0, 0, 0, 0, 0, 0,	                      /* 0x38-0x3f */
  0, 0, 0, 0, 0, 0, 0, 0,	                      /* 0x40-0x47 */
  0, 0, E0_KPSLASH, 0, 0, 0, 0, 0,                    /* 0x48-0x4f */
  0, 0, 0, 0, 0, 0, 0, 0,	                      /* 0x50-0x57 */
  0, 0,  E0_KPENTER, 0, 0, 0, 0, 0,          	      /* 0x58-0x5f */
  0, 0, 0, 0, 0, 0, 0, 0,			      /* 0x60-0x67 */
  0, E0_END, 0,  E0_LEFT, E0_HOME, 0, 0, 0,	      /* 0x68-0x6f */
  E0_INS, E0_DEL, E0_DOWN, 0, E0_RIGHT, E0_DOWN, 0, 0,/* 0x70-0x77 */
  0, 0, E0_PGDN, 0, 0, E0_PGUP, 0, 0		      /* 0x78-0x7f */
};
...
void handle_scancode(unsigned char scancode)
{
	...
	static char up_flag = 0;				 /* 0 or 0200 */
	char raw_mode;

	if (reply_expected) {
	  /* 0xfa, 0xfe only mean "acknowledge", "resend" for most keyboards */
	  /* but they are the key-up sc ncodes for PF6, PF10 on a FOCUS 9000 */
		reply_expected = 0;

		if (scancode == 0xfa) {
		  // printk("\nacknowledge scancode = 0x%x\n",scancode);
			acknowledge = 1;
			return;
		} else if (scancode == 0xfe) {
		  // printk("\nresend scancode = 0x%x\n",scancode);
			resend = 1;
			return;
		}
		/* strange ... */
...
/*  	}  */
	...
	if (!rep ||
		...
		//	printk("shift_state:%x shift_final:%x\n",shift_state,shift_final);
...
static int send_data(unsigned char data)
{
	...
	do{
	  ...
	  //allow_interrupts(); 
	  leon_apbps2->data = data;
	  leon_apbps2->ctrl |= LEON_REG_PS2_CTRL_TE;
	  if(leon_apbps2->ctrl & 0x03)
