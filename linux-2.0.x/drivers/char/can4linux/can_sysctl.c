 ...
 *------------------------------------------------------------------
 * $Header: /cvs/sw/linux-2.4.x/drivers/char/can4linux/can_sysctl.c,v 1.1.1.2 2003/08/29 01:04:37 davidm Exp $
 *
 *--------------------------------------------------------------------------
 *
 *
...
/*For LEON3 Sparc Base adress 0xfffc0000*/
/*changed by hobe */

unsigned int Base[MAX_CHANNELS] = { 0xFFFC0000 };
