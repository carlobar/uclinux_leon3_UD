...
extern int m68360_enet_probe(struct device *dev);
...
extern int fec_init(struct device *);
...
extern int gaisler_greth_probe(struct device *);
...
#if defined(CONFIG_NETtel) && (defined(CONFIG_M5307) || defined(CONFIG_M5272))
